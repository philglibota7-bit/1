...
**Die Crew sieht nach und zeigt.** Ein eigener Agent sah bisher nur seinen Auftrag. Jetzt hat er sieben Werkzeuge und kann damit an der Station nachsehen, dem Nutzer etwas zeigen und, wenn er darum gebeten wird, eine Notiz schreiben oder eine Erinnerung stellen: „Wer wartet gerade auf mich?“, „Was macht webshop-kasse, und wie weit ist sie?“, „Wie viel haben wir im Fenster verbraucht?“, „Zeig mir Tokio“.
...
- In der Vorschau gehen die Werkzeuge über den Betrachter (`tools` von `sample`), wenn er sie ausführen kann; sonst arbeitet die Crew ohne sie. Erlaubt er weniger Werkzeuge, als es gibt, bekommt sie die wichtigsten, der Reihe nach: `station_lage`, `figur_detail`, `zeige_figur`, `tagesbogen`, `zeige_ort`, `erinnern`, `notiz`. Vorher hieß „zu wenige erlaubt“ gar keine, und ein fünftes Werkzeug hätte in so einem Betrachter die anderen vier gekostet.
...
- Fällig heißt: ein Band oben in der Mitte, bernsteinfarben wie „wartet auf dich“, mit Zeit, Text, der Figur, „+10 min“ und „Erledigt“. Hinter dem Namen der Figur steht ◷, bis sie erledigt ist. Dazu ein Eintrag im Bordbuch, eine Mitteilung, wenn ORBIT nicht vorne ist und Mitteilungen an sind, und bei hörbarem Funk der Ruf. Das Band steht außerhalb der übrigen Bedienung und ist deshalb auch im Kinomodus und über einer offenen Blende zu sehen. Auf dem Handy bricht es um, und läuft die Vorführung, steht es unter ihrem Band statt darauf.
