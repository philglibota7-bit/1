...
- **Das Regenradar, auf Wunsch.** Unter Stationswerte → LIVE lässt sich einschalten, dass auf der ganzen Erde steht, wo es gerade regnet oder schneit. Die Daten kommen von RainViewer, zusammengesetzt aus den Wetterradaren vieler Länder, alle zehn Minuten neu, ohne Schlüssel und mit offener Antwort für Browser.
  ...
  - Plastisch: Die Stärke gilt als Höhe, beleuchtet aus der Richtung der echten Sonne, aber immer halbhoch, damit es auch mittags und nachts zu sehen ist. Jede Zelle wirft einen Schatten auf den Boden, auf der Seite, die von der Sonne weg liegt. Nachts leuchtet der Regen gedämpft aus sich selbst, wie die Beschriftung, die über ihm bleibt.
...
99 Tests mit Playwright, ohne echte API-Kosten. Die ganze Reihe läuft gegen einen eingefrorenen Stand. Wo „gegengeprüft“ steht, schlägt der Test gegen die alte oder eine absichtlich kaputte Fassung an.
